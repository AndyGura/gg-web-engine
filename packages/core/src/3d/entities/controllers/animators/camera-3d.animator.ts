...
import { Gg3dWorld, Gg3dWorldTypeDocRepo, VisualTypeDocRepo3D } from '../../../gg-3d-world';
...
export class Camera3dAnimator<VTypeDoc extends VisualTypeDocRepo3D = VisualTypeDocRepo3D> extends AnimationMixer<
  ...
  Point3,
  Point4,
  Gg3dWorldTypeDocRepo & { vTypeDoc: VTypeDoc }
> {
  constructor(
  ...
  onSpawned(world: Gg3dWorld<Gg3dWorldTypeDocRepo & { vTypeDoc: VTypeDoc }>) {

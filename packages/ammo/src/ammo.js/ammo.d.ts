...
declare module Ammo {
  ...
  type btCollisionObject_CollisionFlags =
  ...
  type btCollisionObject_CollisionObjectTypes =
  ...
  type btCollisionObject_AnisotropicFrictionFlags =
  ...
  type btMultibodyLink_eFeatherstoneJointType =
  ...
  class btMultiBody {
    ...
    setupFixed(
      ...
      inertia: btVector3,
      parent: number,
      rotParentToThis: btQuaternion,
      parentComToThisPivotOffset: btVector3,
      thisPivotToThisComOffset: btVector3,
      deprecatedDisableParentCollision?: boolean,
    ): void;
    setupPrismatic(
      i: number,
      mass: number,
      inertia: btVector3,
      parent: number,
      rot_parent_to_this: btQuaternion,
      joint_axis: btVector3,
      parentComToThisPivotOffset: btVector3,
      thisPivotToThisComOffset: btVector3,
      disableParentCollision: boolean,
    ): void;
    setupRevolute(
      i: number,
      mass: number,
      inertia: btVector3,
      parent: number,
      zero_rot_parent_to_this: btQuaternion,
      joint_axis: btVector3,
      parent_axis_position: btVector3,
      my_axis_position: btVector3,
      disableParentCollision?: boolean,
    ): void;
    setupSpherical(
      i: number,
    ...
    setupPlanar(
      ...
      parent: number,
      rotParentToThis: btQuaternion,
      rotationAxis: btVector3,
      parentComToThisComOffset: btVector3,
      disableParentCollision?: boolean,
    ): void;
    ...
    computeAccelerationsArticulatedBodyAlgorithmMultiDof(
      ...
      isConstraintPass: boolean,
      jointFeedbackInWorldSpace: boolean,
      jointFeedbackInJointFrame: boolean,
    ): void;
  ...
  class btMultiBodyDynamicsWorld extends btDiscreteDynamicsWorld {
    constructor(
      dispatcher: btDispatcher,
      pairCache: btBroadphaseInterface,
      constraintSolver: btMultiBodyConstraintSolver,
      collisionConfiguration: btCollisionConfiguration,
    );
  ...
  class btMultiBodyFixedConstraint extends btMultiBodyConstraint {
    constructor(
      ...
      pivotInA: btVector3,
      pivotInB: btVector3,
      frameInA: btMatrix3x3,
      frameInB: btMatrix3x3,
    );
    finalizeMultiDof(): void;
    getIslandIdA(): number;
    getIslandIdB(): number;
    createConstraintRows(
      constraintRows: btMultiBodyConstraintArray,
      data: btMultiBodyJacobianData,
      infoGlobal: btContactSolverInfo,
    ): void;
    getPivotInA(): btVector3;

...
export class GameAudio {
  ...
  public async initAudio() {
    const engineOnMeta: any = await fetch(`https://gg-web-demos.guraklgames.com/assets/fly-city/engine_on.meta.json`);
    ...
    const engineOffMeta: any = await fetch(`https://gg-web-demos.guraklgames.com/assets/fly-city/engine_off.meta.json`);
